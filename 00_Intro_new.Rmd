...
.right-column[
- .small[Язык __R__ является .red[специализированным языком для __анализа данных__], хотя при этом на нем можно решать произвольные  задачи, вплоть до системного программирования]
...
Специализированный журнал (.red[__Q2__] WoS, JCR 2022 = .green[2.1]) о развитии R и его библиотек
...
Высокорейтинговый журнал (.red[__Q1__] WoS, JCR 2023 = .green[5.400]) о разработке статистического программного обеспечения (большинство разработок сделано на .blue[__R__])
