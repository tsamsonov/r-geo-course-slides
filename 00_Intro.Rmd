...
Язык R и пакеты (библиотеки) распространяются через CRAN. Каждый пакет проходит большое количество строгих автоматизированных проверок на работоспособность. В настоящий момент на CRAN доступно .red[__более 18000 пакетов__]!
```{r, echo = F}
