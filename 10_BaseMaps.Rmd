...
<!-- Для классификации объектов необходимо создать соответствующий атрибут, который ранжирует их по величине. Например, можно классифиципровать населенные пункты по численности населения: -->
...
<!-- ```{r, echo = F, ref.label='classes', fig.height=12, crop=T, out.height='1000px'} -->
